...
import { Bot, CircleHelp, Cpu, Download, FileDown, FileUp, FolderOpen, Plus, Save, Settings2, Sparkles } from "lucide-react";
...
export function TopToolbar() {
  ...
  const openAiTools = useAiToolsStore((state) => state.open);
